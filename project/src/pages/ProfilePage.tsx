...
import { User, Mail, Phone, MapPin, Bell, Shield, Camera, Edit2, Save, X } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Receive updates about your complaints</p>
              </div>
            </div>
