...
import { BarChart3, AlertTriangle, CheckCircle, Clock, Activity, Filter, ChevronRight, MapPin, ThumbsUp } from 'lucide-react';

// Mock data for demonstration
const stats = [
  { label: 'Total Complaints', value: '24', icon: AlertTriangle, color: 'bg-blue-50 text-blue-600' },
  { label: 'Resolved', value: '16', icon: CheckCircle, color: 'bg-green-50 text-green-600' },
  { label: 'In Progress', value: '5', icon: Clock, color: 'bg-yellow-50 text-yellow-600' },
  { label: 'Pending', value: '3', icon: Activity, color: 'bg-red-50 text-red-600' },
];
