...
import { Home, FileText, PlusCircle, LayoutDashboard, User, LogIn } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <nav className="mt-4">
            <ul className="flex space-x-6">
              ...
              <li>
                <Link to="/complaints" className="flex items-center space-x-1 text-gray-600 hover:text-gray-900">
                  <FileText className="h-4 w-4" />
                  <span>List Complaints</span>
                </Link>
              </li>
              <li>
                <Link to="/submit" className="flex items-center space-x-1 text-gray-600 hover:text-gray-900">
